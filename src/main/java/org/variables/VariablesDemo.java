...
public class VariablesDemo {
    ...
    public VariablesDemo(int var,int var1) { // constructor can access both static and non static variables
        this.var = var;
        this.var1 = var1;
    ...
    void m1(){ // accessing both static and non static variables
    ...
    static void m2(){
        ...
        var1 = 500; // accessing only static variables
